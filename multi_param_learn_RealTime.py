...
def multi_param_learn(param_list,param_weights,datapath):
    ...
    for dataparam in param_list:
        ...
        labels = {2:'Impact (Front Left)', 3:'Impact (Front Right)', 4:'Impact (Back Left)', 5:'Impact (Back Right)'}
        ...
        #Analyze dataset
        m = KnnDtw(n_neighbors=2, max_warping_window=20)
...
#testing
plist = ['xgyro']#,'mavlink_raw_imu_t_Zaccel']
#pw = [5,4]

multi_param_learn(plist,None,'Data - Real Time Analysis/')