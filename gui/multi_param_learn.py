...
def multi_param_learn(param_list,param_weights,paraname_readable):
    j=-1
    ...
    for dataparam in param_list:
        ...
        def traning_data_plot():
            # plot train data
            plot1 = plt.figure("Training data profile (parameter: " +str(paraname_readable[j]+")") , figsize=(11, 7))
        ...
        # print ("x_train_:"+str(param_list[j]),x_train)
        # print ("y_train_:"+str(param_list[j]),y_train)
