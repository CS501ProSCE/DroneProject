...
# # ****************************    My Code_define_non_parent    *****************************
    ...
    def setupUi(self, parameterSelection):
        ...
        self.Altitude = QtWidgets.QCheckBox(self.widget)
        self.Altitude.setObjectName("Altitude")
        self.gridLayout_2.addWidget(self.Altitude, 4, 0, 1, 1)
        self.Z_vibration = QtWidgets.QCheckBox(self.widget)
        self.Z_vibration.setObjectName("Z_vibration")
        self.gridLayout_2.addWidget(self.Z_vibration, 5, 0, 1, 1)
...
#         self.Confirmation_buttonBox.accepted.connect(self.accept)
 ...
 # ****************************    My Code_confirm selection      *****************************
    ...
    def retranslateUi(self, parameterSelection):
        ...
        self.Altitude.setText(_translate("parameterSelection", "Altitude"))
        self.Z_vibration.setText(_translate("parameterSelection", "Z vibration"))
