    ...
    def datasplicing(self):
        ...
        if self.ui2.radioButton.isChecked():
            ...
            for i in range (1,len(self.para_selection)):
                GUIFunctions.main3(self.readedFileList[0],self.para_selection[i],self.b[3])
        ...
        if self.ui2.radioButton_2.isChecked():
            ...
            for i in range(1, len(self.para_selection)):
                ...
                GUIFunctions.main4(self.readedFileList[0], self.para_selection[i], self.b[1])
...
# ****************************    My Code_display prediction   ****************
    def machinelearning(self):
        ...
        self.label_result = multi_param_learn.machine_learning(self.learning[0], self.learning[1], self.learning[2],self.learning[3],self.learning[4],self.learning[5],self.learning[6],self.k_value)
        ...
        multi_param_learn.test_data_plot(self.para_selection_name[0],self.learning[0][0])
...
# ****************************    My Code_display training data     ************
    def traning_data_display(self):
        ...
        multi_param_learn.training_data_plot(self.para_selection_name[0],learning[1][0],learning[2][0],learning[3][0])
