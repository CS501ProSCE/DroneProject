# -*- coding: utf-8 -*-
# Below GUI codes are writton by Mo Lv
...
# ****************************    My Code_data select paramter     *************
    ...
    def confirmed(self):
        self.para_dic2={"Pitch":"mavlink_ahrs3_t_pitch",
                       ...
                       "Pitch angle":"mavlink_attitude_t_pitch angle","X Accel":"mavlink_raw_imu_t_Xaccel",
                       ...
                       "Z Accel":"mavlink_raw_imu_t_Zaccel","Z Gyro":"mavlink_raw_imu_t_ZGyro","Z Mag":"mavlink_raw_imu_t_ZMag",
                        "Roll angle":"mavlink_attitude_t_roll angle","Yaw rate":"mavlink_attitude_t_yaw rate"}
        self.para_dic = {"Pitch": "pitch",
                         "Yaw": "yaw", "Pitch rate": "pitch rate",
                         "Roll rate": "roll rate",
                         "Yaw angle": "yaw angle",
                         "Roll": "roll",
                         "Pitch angle": "pitch angle", "X Accel": "Xaccel",
                         "X Gyro": "XGyro", "X Mag": "XMag",
                         "Y Accel": "Yaccel", "Y Gyro": "YGyro",
                         "Y Mag": "YMag",
                         "Z Accel": "Zaccel", "Z Gyro": "ZGyro",
                         "Z Mag": "ZMag",
                         "Roll angle": "roll angle","Yaw rate":"yaw rate"}
        ...
        if self.ui.Pitch_angle.isChecked():
            # self.selection.append("mavlink_ahrs2_t_altitude")
            self.selection_name.append("Pitch angle")
        ...
        if self.ui.Roll_angle.isChecked():
            # self.selection.append("mavlink_vibration_t_vibration_z")
            self.selection_name.append("Roll angle")
...
# ****************************    My Code_display prediction   ****************
    def machinelearning(self):
        ...
        if ok:
            ...
            del self.b[1][len(self.b[1])-1]
            self.label_color=[]
            self.event_labels=[]
            i=0
            for key in self.label_result[1]:
                if key !=1:
                    self.label_color.append(self.learning[7][key])

                    self.event_labels.append("event "+str(i+1)+" : "+ self.learning[3][key])
                else:
                    del self.x_test_final[0][i]
                i=i+1


            multi_param_learn.test_data_plot(self.para_selection_name[0], self.x_test_final[0],self.label_color,self.event_labels)
