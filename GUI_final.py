...
# **************************** My initialtion ************************
    def setupUi(self):
        ...
        self.label_1.setGeometry(QtCore.QRect(20, 211, 160, 16))
...
# **************************** My Code_splice data automatically ***********
        self.pushButton_4.clicked.connect(self.datasplicing)
# **************************** My Code_splice data automatically ***********
...
# **************************** My code_delete parameter ********************
    ...
    def retranslateUi(self, DroneGUI):
        ...
        self.label_1.setText(_translate("DroneGUI", "Selected Test Datasets to Predict"))
...
# ****************************    My Code_data select paramter     *************
    ...
    def confirmed(self):
        self.para_dic={"Pitch":"mavlink_nav_controller_output_t_nav_pitch",
...
# ****************************    My Code_data splice       ********************
    def datasplicing(self):
        ...
        self.train_data_name =SpliceDataFunctions.main(self.readedFileList[0],self.para_selection[0],self.para_selection_name[0])
...
# ****************************    My Code_display prediction   ****************
    ...
    def machinelearning(self):
        ...
        Learn_original.learn(self.train_data_name,self.para_selection_name)
...
# ****************************    My Code_display training data     ************
    def traning_data_display(self):
        ...
        multi_param_learn.multi_param_learn(self.para_selection, None, self.para_selection_name)
...
# ****************************    My Code_display test data         ************
    ...
    def test_data_display(self):
        ...
        SpliceDataFunctions.plotTSData(a,self.para_selection_name[0])
